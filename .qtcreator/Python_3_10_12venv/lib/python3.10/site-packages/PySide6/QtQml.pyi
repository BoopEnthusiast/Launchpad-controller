...
class QQmlApplicationEngine(PySide6.QtQml.QQmlEngine):
    ...
    @overload
    def load(self, filePath: Union[str, bytes, os.PathLike[str]]) -> None: ...
    @overload
...
class QQmlEngine(PySide6.QtQml.QJSEngine):
    ...
    def addImportPath(self, dir: Union[str, bytes, os.PathLike[str]]) -> None: ...
    def addNamedBundle(self, arg__1: str, arg__2: str) -> bool: ...
    def addPluginPath(self, dir: Union[str, bytes, os.PathLike[str]]) -> None: ...
    ...
    @overload
    def singletonInstance(self, qmlTypeId: int) -> Union[PySide6.QtCore.QObject, PySide6.QtQml.QJSValue, NoneType]: ...
    @overload
    def singletonInstance(self, uri: str, typeName: str) -> Union[PySide6.QtCore.QObject, PySide6.QtQml.QJSValue, NoneType]: ...
...
class QQmlFile(Shiboken.Object):
    ...
    @overload
    def __init__(self, engine: PySide6.QtQml.QQmlEngine, url: Union[PySide6.QtCore.QUrl, str]) -> None: ...
