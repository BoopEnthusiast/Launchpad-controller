...
enum [[deprecated]] : int {
    ...
    SBK_QTWEBCHANNEL_QLIST_QOBJECTPTR_IDX                    = 2, // QList<QObject*>
    SBK_QTWEBCHANNEL_QLIST_QBYTEARRAY_IDX                    = 4, // QList<QByteArray>
    SBK_QTWEBCHANNEL_QHASH_QSTRING_QOBJECTPTR_IDX            = 6, // QHash<QString,QObject*>
    SBK_QTWEBCHANNEL_QLIST_QVARIANT_IDX                      = 8, // QList<QVariant>
    SBK_QTWEBCHANNEL_QLIST_QSTRING_IDX                       = 10, // QList<QString>
    SBK_QTWEBCHANNEL_QMAP_QSTRING_QVARIANT_IDX               = 12, // QMap<QString,QVariant>
    SBK_QTWEBCHANNEL_CONVERTERS_IDX_COUNT                    = 14,
};
