...
enum [[deprecated]] : int {
    ...
    SBK_QT3DRENDER_QDEPTHRANGE_IDX                           = 88,
    SBK_QT3DRENDER_QDEPTHTEST_DEPTHFUNCTION_IDX              = 92,
    SBK_QT3DRENDER_QDEPTHTEST_IDX                            = 90,
    SBK_QT3DRENDER_QDIRECTIONALLIGHT_IDX                     = 94,
    SBK_QT3DRENDER_QDISPATCHCOMPUTE_IDX                      = 96,
    SBK_QT3DRENDER_QDITHERING_IDX                            = 98,
    SBK_QT3DRENDER_QEFFECT_IDX                               = 100,
    SBK_QT3DRENDER_QENVIRONMENTLIGHT_IDX                     = 102,
    SBK_QT3DRENDER_QFILTERKEY_IDX                            = 104,
    SBK_QT3DRENDER_QFRAMEGRAPHNODE_IDX                       = 106,
    SBK_QT3DRENDER_QFRONTFACE_WINDINGDIRECTION_IDX           = 110,
    SBK_QT3DRENDER_QFRONTFACE_IDX                            = 108,
    SBK_QT3DRENDER_QFRUSTUMCULLING_IDX                       = 112,
    SBK_QT3DRENDER_QGEOMETRYRENDERER_PRIMITIVETYPE_IDX       = 116,
    SBK_QT3DRENDER_QGEOMETRYRENDERER_IDX                     = 114,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_API_IDX                = 120,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_OPENGLPROFILE_IDX      = 122,
    SBK_QT3DRENDER_QGRAPHICSAPIFILTER_IDX                    = 118,
    SBK_QT3DRENDER_QLAYER_IDX                                = 124,
    SBK_QT3DRENDER_QLAYERFILTER_FILTERMODE_IDX               = 128,
    SBK_QT3DRENDER_QLAYERFILTER_IDX                          = 126,
    SBK_QT3DRENDER_QLEVELOFDETAIL_THRESHOLDTYPE_IDX          = 132,
    SBK_QT3DRENDER_QLEVELOFDETAIL_IDX                        = 130,
    SBK_QT3DRENDER_QLEVELOFDETAILBOUNDINGSPHERE_IDX          = 134,
    SBK_QT3DRENDER_QLEVELOFDETAILSWITCH_IDX                  = 136,
    SBK_QT3DRENDER_QLINEWIDTH_IDX                            = 138,
    SBK_QT3DRENDER_QMATERIAL_IDX                             = 140,
    SBK_QT3DRENDER_QMEMORYBARRIER_OPERATION_IDX              = 144,
    SBK_QFLAGS_QT3DRENDER_QMEMORYBARRIER_OPERATION_IDX       = 2,
    SBK_QT3DRENDER_QMEMORYBARRIER_IDX                        = 142,
    SBK_QT3DRENDER_QMESH_STATUS_IDX                          = 148,
    SBK_QT3DRENDER_QMESH_IDX                                 = 146,
    SBK_QT3DRENDER_QMULTISAMPLEANTIALIASING_IDX              = 150,
    SBK_QT3DRENDER_QNODEPTHMASK_IDX                          = 152,
    SBK_QT3DRENDER_QNODRAW_IDX                               = 154,
    SBK_QT3DRENDER_QNOPICKING_IDX                            = 156,
    SBK_QT3DRENDER_QOBJECTPICKER_IDX                         = 158,
    SBK_QT3DRENDER_QPAINTEDTEXTUREIMAGE_IDX                  = 160,
    SBK_QT3DRENDER_QPARAMETER_IDX                            = 162,
    SBK_QT3DRENDER_QPICKEVENT_BUTTONS_IDX                    = 166,
    SBK_QT3DRENDER_QPICKEVENT_MODIFIERS_IDX                  = 168,
    SBK_QT3DRENDER_QPICKEVENT_IDX                            = 164,
    SBK_QT3DRENDER_QPICKLINEEVENT_IDX                        = 170,
    SBK_QT3DRENDER_QPICKPOINTEVENT_IDX                       = 172,
    SBK_QT3DRENDER_QPICKTRIANGLEEVENT_IDX                    = 174,
    SBK_QT3DRENDER_QPICKINGPROXY_IDX                         = 176,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKMETHOD_IDX           = 182,
    SBK_QT3DRENDER_QPICKINGSETTINGS_PICKRESULTMODE_IDX       = 184,
    SBK_QT3DRENDER_QPICKINGSETTINGS_FACEORIENTATIONPICKINGMODE_IDX = 180,
    SBK_QT3DRENDER_QPICKINGSETTINGS_IDX                      = 178,
    SBK_QT3DRENDER_QPOINTLIGHT_IDX                           = 186,
    SBK_QT3DRENDER_QPOINTSIZE_SIZEMODE_IDX                   = 190,
    SBK_QT3DRENDER_QPOINTSIZE_IDX                            = 188,
    SBK_QT3DRENDER_QPOLYGONOFFSET_IDX                        = 192,
    SBK_QT3DRENDER_QPROXIMITYFILTER_IDX                      = 194,
    SBK_QT3DRENDER_QRASTERMODE_RASTERMODE_IDX                = 200,
    SBK_QT3DRENDER_QRASTERMODE_FACEMODE_IDX                  = 198,
    SBK_QT3DRENDER_QRASTERMODE_IDX                           = 196,
    SBK_QT3DRENDER_QRAYCASTER_IDX                            = 202,
    SBK_QT3DRENDER_QRAYCASTERHIT_HITTYPE_IDX                 = 206,
    SBK_QT3DRENDER_QRAYCASTERHIT_IDX                         = 204,
    SBK_QT3DRENDER_QRENDERASPECT_SUBMISSIONTYPE_IDX          = 210,
    SBK_QT3DRENDER_QRENDERASPECT_IDX                         = 208,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_API_IDX               = 214,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_PROFILE_IDX           = 216,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_IDX                   = 212,
    SBK_QT3DRENDER_QRENDERCAPTURE_IDX                        = 218,
    SBK_QT3DRENDER_QRENDERCAPTUREREPLY_IDX                   = 220,
    SBK_QT3DRENDER_QRENDERPASS_IDX                           = 222,
    SBK_QT3DRENDER_QRENDERPASSFILTER_IDX                     = 224,
    SBK_QT3DRENDER_QRENDERSETTINGS_RENDERPOLICY_IDX          = 228,
    SBK_QT3DRENDER_QRENDERSETTINGS_IDX                       = 226,
    SBK_QT3DRENDER_QRENDERSTATE_IDX                          = 230,
    SBK_QT3DRENDER_QRENDERSTATESET_IDX                       = 232,
    SBK_QT3DRENDER_QRENDERSURFACESELECTOR_IDX                = 234,
    SBK_QT3DRENDER_QRENDERTARGET_IDX                         = 236,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_ATTACHMENTPOINT_IDX   = 240,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_IDX                   = 238,
    SBK_QT3DRENDER_QRENDERTARGETSELECTOR_IDX                 = 242,
    SBK_QT3DRENDER_QSCENELOADER_STATUS_IDX                   = 248,
    SBK_QT3DRENDER_QSCENELOADER_COMPONENTTYPE_IDX            = 246,
    SBK_QT3DRENDER_QSCENELOADER_IDX                          = 244,
    SBK_QT3DRENDER_QSCISSORTEST_IDX                          = 250,
    SBK_QT3DRENDER_QSCREENRAYCASTER_IDX                      = 252,
    SBK_QT3DRENDER_QSEAMLESSCUBEMAP_IDX                      = 254,
    SBK_QT3DRENDER_QSETFENCE_HANDLETYPE_IDX                  = 258,
    SBK_QT3DRENDER_QSETFENCE_IDX                             = 256,
    SBK_QT3DRENDER_QSHADERDATA_IDX                           = 260,
    SBK_QT3DRENDER_QSHADERIMAGE_ACCESS_IDX                   = 264,
    SBK_QT3DRENDER_QSHADERIMAGE_IMAGEFORMAT_IDX              = 266,
    SBK_QT3DRENDER_QSHADERIMAGE_IDX                          = 262,
    SBK_QT3DRENDER_QSHADERPROGRAM_SHADERTYPE_IDX             = 272,
    SBK_QT3DRENDER_QSHADERPROGRAM_STATUS_IDX                 = 274,
    SBK_QT3DRENDER_QSHADERPROGRAM_FORMAT_IDX                 = 270,
    SBK_QT3DRENDER_QSHADERPROGRAM_IDX                        = 268,
    SBK_QT3DRENDER_QSHADERPROGRAMBUILDER_IDX                 = 276,
    SBK_QT3DRENDER_QSHAREDGLTEXTURE_IDX                      = 278,
    SBK_QT3DRENDER_QSORTPOLICY_SORTTYPE_IDX                  = 282,
    SBK_QT3DRENDER_QSORTPOLICY_IDX                           = 280,
    SBK_QT3DRENDER_QSPOTLIGHT_IDX                            = 284,
    SBK_QT3DRENDER_QSTENCILMASK_IDX                          = 286,
    SBK_QT3DRENDER_QSTENCILOPERATION_IDX                     = 288,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_FACEMODE_IDX   = 292,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_OPERATION_IDX  = 294,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_IDX            = 290,
    SBK_QT3DRENDER_QSTENCILTEST_IDX                          = 296,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFACEMODE_IDX = 300,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFUNCTION_IDX = 302,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_IDX                 = 298,
    SBK_QT3DRENDER_QSUBTREEENABLER_ENABLEMENT_IDX            = 306,
    SBK_QT3DRENDER_QSUBTREEENABLER_IDX                       = 304,
    SBK_QT3DRENDER_QTECHNIQUE_IDX                            = 308,
    SBK_QT3DRENDER_QTECHNIQUEFILTER_IDX                      = 310,
    SBK_QT3DRENDER_QTEXTURE1D_IDX                            = 312,
    SBK_QT3DRENDER_QTEXTURE1DARRAY_IDX                       = 314,
    SBK_QT3DRENDER_QTEXTURE2D_IDX                            = 316,
    SBK_QT3DRENDER_QTEXTURE2DARRAY_IDX                       = 318,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLE_IDX                 = 320,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLEARRAY_IDX            = 322,
    SBK_QT3DRENDER_QTEXTURE3D_IDX                            = 324,
    SBK_QT3DRENDER_QTEXTUREBUFFER_IDX                        = 326,
    SBK_QT3DRENDER_QTEXTURECUBEMAP_IDX                       = 328,
    SBK_QT3DRENDER_QTEXTURECUBEMAPARRAY_IDX                  = 330,
    SBK_QT3DRENDER_QTEXTUREDATA_IDX                          = 332,
    SBK_QT3DRENDER_QTEXTUREDATAUPDATE_IDX                    = 334,
    SBK_QT3DRENDER_QTEXTUREIMAGE_STATUS_IDX                  = 338,
    SBK_QT3DRENDER_QTEXTUREIMAGE_IDX                         = 336,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATA_IDX                     = 340,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX            = 342,
    SBK_QT3DRENDER_QTEXTURELOADER_IDX                        = 344,
    SBK_QT3DRENDER_QTEXTURERECTANGLE_IDX                     = 346,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_WRAPMODE_IDX             = 350,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_IDX                      = 348,
    SBK_QT3DRENDER_QVIEWPORT_IDX                             = 352,
    SBK_QT3DRENDER_QWAITFENCE_HANDLETYPE_IDX                 = 356,
    SBK_QT3DRENDER_QWAITFENCE_IDX                            = 354,
    SBK_QSHAREDPOINTER_QT3DRENDER_QTEXTUREIMAGEDATA_IDX      = 358, // QSharedPointer<Qt3DRender::QTextureImageData>
    SBK_QSHAREDPOINTER_CONSTQT3DRENDER_QTEXTUREIMAGEDATA_IDX = 358, // (const)
    SBK_QSHAREDPOINTER_QT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX = 360, // QSharedPointer<Qt3DRender::QTextureImageDataGenerator>
    SBK_QSHAREDPOINTER_CONSTQT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX = 360, // (const)
    SBK_QSHAREDPOINTER_QT3DRENDER_PROPERTYREADERINTERFACE_IDX = 362, // QSharedPointer<Qt3DRender::PropertyReaderInterface>
    SBK_QSHAREDPOINTER_CONSTQT3DRENDER_PROPERTYREADERINTERFACE_IDX = 362, // (const)
    SBK_QT3DRENDER_IDX_COUNT                                 = 364,
};
