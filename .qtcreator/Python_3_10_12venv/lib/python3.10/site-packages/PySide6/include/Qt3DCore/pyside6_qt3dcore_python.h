...
enum [[deprecated]] : int {
    ...
    SBK_QT3DCORE_QCORESETTINGS_IDX                           = 40,
    SBK_QT3DCORE_QENTITY_IDX                                 = 42,
    SBK_QT3DCORE_QGEOMETRY_IDX                               = 44,
    SBK_QT3DCORE_QGEOMETRYVIEW_PRIMITIVETYPE_IDX             = 48,
    SBK_QT3DCORE_QGEOMETRYVIEW_IDX                           = 46,
    SBK_QT3DCORE_QJOINT_IDX                                  = 50,
    SBK_QT3DCORE_QNODE_IDX                                   = 52,
    SBK_QT3DCORE_QNODEID_IDX                                 = 54,
    SBK_QT3DCORE_QNODEIDTYPEPAIR_IDX                         = 56,
    SBK_QT3DCORE_QSKELETON_IDX                               = 58,
    SBK_QT3DCORE_QSKELETONLOADER_STATUS_IDX                  = 62,
    SBK_QT3DCORE_QSKELETONLOADER_IDX                         = 60,
    SBK_QT3DCORE_QTRANSFORM_IDX                              = 64,
    SBK_QSHAREDPOINTER_QT3DCORE_QASPECTJOB_IDX               = 66, // QSharedPointer<Qt3DCore::QAspectJob>
    SBK_QSHAREDPOINTER_CONSTQT3DCORE_QASPECTJOB_IDX          = 66, // (const)
    SBK_QSHAREDPOINTER_QT3DCORE_QBACKENDNODEMAPPER_IDX       = 68, // QSharedPointer<Qt3DCore::QBackendNodeMapper>
    SBK_QSHAREDPOINTER_CONSTQT3DCORE_QBACKENDNODEMAPPER_IDX  = 68, // (const)
    SBK_QSHAREDPOINTER_QT3DCORE_QENTITY_IDX                  = 70, // QSharedPointer<Qt3DCore::QEntity>
    SBK_QSHAREDPOINTER_CONSTQT3DCORE_QENTITY_IDX             = 70, // (const)
    SBK_QT3DCORE_IDX_COUNT                                   = 72,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QT3DCORE_QLIST_QBYTEARRAY_IDX                        = 4, // QList<QByteArray>
    SBK_QT3DCORE_STD_VECTOR_QSHAREDPOINTER_QT3DCORE_QASPECTJOB_IDX = 6, // std::vector<QSharedPointer< Qt3DCore::QAspectJob>>
