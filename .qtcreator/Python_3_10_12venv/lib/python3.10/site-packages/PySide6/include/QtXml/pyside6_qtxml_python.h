...
enum [[deprecated]] : int {
    ...
    SBK_QFLAGS_QDOMDOCUMENT_PARSEOPTION_IDX                  = 42,
    SBK_QDOMDOCUMENT_IDX                                     = 8,
    SBK_QDOMDOCUMENTFRAGMENT_IDX                             = 12,
    SBK_QDOMDOCUMENTTYPE_IDX                                 = 14,
    SBK_QDOMELEMENT_IDX                                      = 16,
    SBK_QDOMENTITY_IDX                                       = 18,
    SBK_QDOMENTITYREFERENCE_IDX                              = 20,
    SBK_QDOMIMPLEMENTATION_INVALIDDATAPOLICY_IDX             = 24,
    SBK_QDOMIMPLEMENTATION_IDX                               = 22,
    SBK_QDOMNAMEDNODEMAP_IDX                                 = 26,
    SBK_QDOMNODE_NODETYPE_IDX                                = 32,
    SBK_QDOMNODE_ENCODINGPOLICY_IDX                          = 30,
    SBK_QDOMNODE_IDX                                         = 28,
    SBK_QDOMNODELIST_IDX                                     = 34,
    SBK_QDOMNOTATION_IDX                                     = 36,
    SBK_QDOMPROCESSINGINSTRUCTION_IDX                        = 38,
    SBK_QDOMTEXT_IDX                                         = 40,
    SBK_QTXML_IDX_COUNT                                      = 44,
};
