...
enum [[deprecated]] : int {
    ...
    SBK_QT3DANIMATION_QABSTRACTANIMATION_ANIMATIONTYPE_IDX   = 4,
    SBK_QT3DANIMATION_QABSTRACTANIMATION_IDX                 = 2,
    SBK_QT3DANIMATION_QABSTRACTANIMATIONCLIP_IDX             = 6,
    SBK_QT3DANIMATION_QABSTRACTCHANNELMAPPING_IDX            = 8,
    SBK_QT3DANIMATION_QABSTRACTCLIPANIMATOR_LOOPS_IDX        = 12,
    SBK_QT3DANIMATION_QABSTRACTCLIPANIMATOR_IDX              = 10,
    SBK_QT3DANIMATION_QABSTRACTCLIPBLENDNODE_IDX             = 14,
    SBK_QT3DANIMATION_QADDITIVECLIPBLEND_IDX                 = 16,
    SBK_QT3DANIMATION_QANIMATIONASPECT_IDX                   = 18,
    SBK_QT3DANIMATION_QANIMATIONCALLBACK_FLAG_IDX            = 22,
    SBK_QT3DANIMATION_QANIMATIONCALLBACK_IDX                 = 20,
    SBK_QT3DANIMATION_QANIMATIONCLIP_IDX                     = 24,
    SBK_QT3DANIMATION_QANIMATIONCLIPDATA_IDX                 = 26,
    SBK_QT3DANIMATION_QANIMATIONCLIPLOADER_STATUS_IDX        = 30,
    SBK_QT3DANIMATION_QANIMATIONCLIPLOADER_IDX               = 28,
    SBK_QT3DANIMATION_QANIMATIONCONTROLLER_IDX               = 32,
    SBK_QT3DANIMATION_QANIMATIONGROUP_IDX                    = 34,
    SBK_QT3DANIMATION_QBLENDEDCLIPANIMATOR_IDX               = 36,
    SBK_QT3DANIMATION_QCHANNEL_IDX                           = 38,
    SBK_QT3DANIMATION_QCHANNELCOMPONENT_IDX                  = 40,
    SBK_QT3DANIMATION_QCHANNELMAPPER_IDX                     = 42,
    SBK_QT3DANIMATION_QCHANNELMAPPING_IDX                    = 44,
    SBK_QT3DANIMATION_QCLIPANIMATOR_IDX                      = 46,
    SBK_QT3DANIMATION_QCLIPBLENDVALUE_IDX                    = 48,
    SBK_QT3DANIMATION_QCLOCK_IDX                             = 50,
    SBK_QT3DANIMATION_QKEYFRAME_INTERPOLATIONTYPE_IDX        = 54,
    SBK_QT3DANIMATION_QKEYFRAME_IDX                          = 52,
    SBK_QT3DANIMATION_QKEYFRAMEANIMATION_REPEATMODE_IDX      = 58,
    SBK_QT3DANIMATION_QKEYFRAMEANIMATION_IDX                 = 56,
    SBK_QT3DANIMATION_QLERPCLIPBLEND_IDX                     = 60,
    SBK_QT3DANIMATION_QMORPHTARGET_IDX                       = 62,
    SBK_QT3DANIMATION_QMORPHINGANIMATION_METHOD_IDX          = 66,
    SBK_QT3DANIMATION_QMORPHINGANIMATION_IDX                 = 64,
    SBK_QT3DANIMATION_QSKELETONMAPPING_IDX                   = 68,
    SBK_QT3DANIMATION_QVERTEXBLENDANIMATION_IDX              = 70,
    SBK_QT3DANIMATION_IDX_COUNT                              = 72,
};
