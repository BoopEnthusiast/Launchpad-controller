...
enum [[deprecated]] : int {
    ...
    SBK_QTWEBENGINEWIDGETS_QLIST_QACTIONPTR_IDX              = 2, // QList<QAction*>
    SBK_QTWEBENGINEWIDGETS_QLIST_QVARIANT_IDX                = 4, // QList<QVariant>
    SBK_QTWEBENGINEWIDGETS_QLIST_QSTRING_IDX                 = 6, // QList<QString>
