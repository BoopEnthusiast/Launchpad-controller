...
def _find_all_qt_modules():
    ...
    in_build = Path("/home/qt/work/pyside/pyside-setup/build/qfpa-py3.11-qt6.7.0-64bit-release/build/pyside6") in location.parents
