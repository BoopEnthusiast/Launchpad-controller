...
enum [[deprecated]] : int {
    ...
    SBK_QWEBENGINECONTEXTMENUREQUEST_MEDIATYPE_IDX           = 20,
    SBK_QWEBENGINECONTEXTMENUREQUEST_MEDIAFLAG_IDX           = 18,
    SBK_QFLAGS_QWEBENGINECONTEXTMENUREQUEST_MEDIAFLAG_IDX    = 2,
    SBK_QWEBENGINECONTEXTMENUREQUEST_EDITFLAG_IDX            = 16,
    SBK_QFLAGS_QWEBENGINECONTEXTMENUREQUEST_EDITFLAG_IDX     = 0,
    SBK_QWEBENGINECONTEXTMENUREQUEST_IDX                     = 14,
    SBK_QWEBENGINECOOKIESTORE_IDX                            = 22,
    SBK_QWEBENGINECOOKIESTORE_FILTERREQUEST_IDX              = 24,
    SBK_QWEBENGINEDOWNLOADREQUEST_DOWNLOADSTATE_IDX          = 30,
    SBK_QWEBENGINEDOWNLOADREQUEST_SAVEPAGEFORMAT_IDX         = 32,
    SBK_QWEBENGINEDOWNLOADREQUEST_DOWNLOADINTERRUPTREASON_IDX = 28,
    SBK_QWEBENGINEDOWNLOADREQUEST_IDX                        = 26,
    SBK_QWEBENGINEFILESYSTEMACCESSREQUEST_HANDLETYPE_IDX     = 38,
    SBK_QWEBENGINEFILESYSTEMACCESSREQUEST_ACCESSFLAG_IDX     = 36,
    SBK_QFLAGS_QWEBENGINEFILESYSTEMACCESSREQUEST_ACCESSFLAG_IDX = 4,
    SBK_QWEBENGINEFILESYSTEMACCESSREQUEST_IDX                = 34,
    SBK_QWEBENGINEFINDTEXTRESULT_IDX                         = 40,
    SBK_QWEBENGINEFULLSCREENREQUEST_IDX                      = 42,
    SBK_QWEBENGINEHISTORY_IDX                                = 44,
    SBK_QWEBENGINEHISTORYITEM_IDX                            = 46,
    SBK_QWEBENGINEHISTORYMODEL_ROLES_IDX                     = 50,
    SBK_QWEBENGINEHISTORYMODEL_IDX                           = 48,
    SBK_QWEBENGINEHTTPREQUEST_METHOD_IDX                     = 54,
    SBK_QWEBENGINEHTTPREQUEST_IDX                            = 52,
    SBK_QWEBENGINELOADINGINFO_LOADSTATUS_IDX                 = 60,
    SBK_QWEBENGINELOADINGINFO_ERRORDOMAIN_IDX                = 58,
    SBK_QWEBENGINELOADINGINFO_IDX                            = 56,
    SBK_QWEBENGINENEWWINDOWREQUEST_DESTINATIONTYPE_IDX       = 64,
    SBK_QWEBENGINENEWWINDOWREQUEST_IDX                       = 62,
    SBK_QWEBENGINENOTIFICATION_IDX                           = 66,
    SBK_QWEBENGINEPAGE_WEBACTION_IDX                         = 86,
    SBK_QWEBENGINEPAGE_FINDFLAG_IDX                          = 74,
    SBK_QFLAGS_QWEBENGINEPAGE_FINDFLAG_IDX                   = 6,
    SBK_QWEBENGINEPAGE_WEBWINDOWTYPE_IDX                     = 88,
    SBK_QWEBENGINEPAGE_PERMISSIONPOLICY_IDX                  = 82,
    SBK_QWEBENGINEPAGE_NAVIGATIONTYPE_IDX                    = 80,
    SBK_QWEBENGINEPAGE_FEATURE_IDX                           = 70,
    SBK_QWEBENGINEPAGE_FILESELECTIONMODE_IDX                 = 72,
    SBK_QWEBENGINEPAGE_JAVASCRIPTCONSOLEMESSAGELEVEL_IDX     = 76,
    SBK_QWEBENGINEPAGE_RENDERPROCESSTERMINATIONSTATUS_IDX    = 84,
    SBK_QWEBENGINEPAGE_LIFECYCLESTATE_IDX                    = 78,
    SBK_QWEBENGINEPAGE_IDX                                   = 68,
    SBK_QWEBENGINEPROFILE_HTTPCACHETYPE_IDX                  = 92,
    SBK_QWEBENGINEPROFILE_PERSISTENTCOOKIESPOLICY_IDX        = 94,
    SBK_QWEBENGINEPROFILE_IDX                                = 90,
    SBK_QWEBENGINEQUOTAREQUEST_IDX                           = 96,
    SBK_QWEBENGINEREGISTERPROTOCOLHANDLERREQUEST_IDX         = 98,
    SBK_QWEBENGINESCRIPT_INJECTIONPOINT_IDX                  = 102,
    SBK_QWEBENGINESCRIPT_SCRIPTWORLDID_IDX                   = 104,
    SBK_QWEBENGINESCRIPT_IDX                                 = 100,
    SBK_QWEBENGINESCRIPTCOLLECTION_IDX                       = 106,
    SBK_QWEBENGINESETTINGS_FONTFAMILY_IDX                    = 110,
    SBK_QWEBENGINESETTINGS_WEBATTRIBUTE_IDX                  = 116,
    SBK_QWEBENGINESETTINGS_FONTSIZE_IDX                      = 112,
    SBK_QWEBENGINESETTINGS_UNKNOWNURLSCHEMEPOLICY_IDX        = 114,
    SBK_QWEBENGINESETTINGS_IDX                               = 108,
    SBK_QWEBENGINEURLREQUESTINFO_RESOURCETYPE_IDX            = 122,
    SBK_QWEBENGINEURLREQUESTINFO_NAVIGATIONTYPE_IDX          = 120,
    SBK_QWEBENGINEURLREQUESTINFO_IDX                         = 118,
    SBK_QWEBENGINEURLREQUESTINTERCEPTOR_IDX                  = 124,
    SBK_QWEBENGINEURLREQUESTJOB_ERROR_IDX                    = 128,
    SBK_QWEBENGINEURLREQUESTJOB_IDX                          = 126,
    SBK_QWEBENGINEURLSCHEME_SYNTAX_IDX                       = 136,
    SBK_QWEBENGINEURLSCHEME_SPECIALPORT_IDX                  = 134,
    SBK_QWEBENGINEURLSCHEME_FLAG_IDX                         = 132,
    SBK_QFLAGS_QWEBENGINEURLSCHEME_FLAG_IDX                  = 8,
    SBK_QWEBENGINEURLSCHEME_IDX                              = 130,
    SBK_QWEBENGINEURLSCHEMEHANDLER_IDX                       = 138,
    SBK_QWEBENGINEWEBAUTHPINREQUEST_IDX                      = 140,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_WEBAUTHUXSTATE_IDX        = 150,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_PINENTRYREASON_IDX        = 146,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_PINENTRYERROR_IDX         = 144,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_REQUESTFAILUREREASON_IDX  = 148,
    SBK_QWEBENGINEWEBAUTHUXREQUEST_IDX                       = 142,
    SBK_QTWEBENGINECORE_IDX_COUNT                            = 152,
};
...
enum : int {
    ...
    SBK_QWebEngineWebAuthPinRequest_IDX                      = 70,
    SBK_QWebEngineWebAuthUxRequest_WebAuthUxState_IDX        = 75,
    SBK_QWebEngineWebAuthUxRequest_PinEntryReason_IDX        = 73,
    SBK_QWebEngineWebAuthUxRequest_PinEntryError_IDX         = 72,
    SBK_QWebEngineWebAuthUxRequest_RequestFailureReason_IDX  = 74,
    SBK_QWebEngineWebAuthUxRequest_IDX                       = 71,
    SBK_QtWebEngineCore_IDX_COUNT                            = 76,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QTWEBENGINECORE_QMAP_QSTRING_QSTRING_IDX             = 20, // QMap<QString,QString>
    SBK_QTWEBENGINECORE_QMAP_INT_QVARIANT_IDX                = 22, // QMap<int,QVariant>
    SBK_QTWEBENGINECORE_QLIST_QMODELINDEX_IDX                = 24, // QList<QModelIndex>
    SBK_QTWEBENGINECORE_QHASH_INT_QBYTEARRAY_IDX             = 26, // QHash<int,QByteArray>
    SBK_QTWEBENGINECORE_QLIST_QVARIANT_IDX                   = 28, // QList<QVariant>
    SBK_QTWEBENGINECORE_QLIST_QSTRING_IDX                    = 30, // QList<QString>
    SBK_QTWEBENGINECORE_QMAP_QSTRING_QVARIANT_IDX            = 32, // QMap<QString,QVariant>
    SBK_QTWEBENGINECORE_CONVERTERS_IDX_COUNT                 = 34,
};
