...
enum [[deprecated]] : int {
    ...
    SBK_QTSVGWIDGETS_QLIST_QACTIONPTR_IDX                    = 2, // QList<QAction*>
    SBK_QTSVGWIDGETS_QLIST_QVARIANT_IDX                      = 4, // QList<QVariant>
    SBK_QTSVGWIDGETS_QLIST_QSTRING_IDX                       = 6, // QList<QString>
    SBK_QTSVGWIDGETS_QMAP_QSTRING_QVARIANT_IDX               = 8, // QMap<QString,QVariant>
    SBK_QTSVGWIDGETS_CONVERTERS_IDX_COUNT                    = 10,
};
