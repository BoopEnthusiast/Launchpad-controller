...
// Type indices
enum [[deprecated]] : int {
    SBK_QGEOCODEREPLY_ERROR_IDX                              = 24,
    SBK_QGEOCODEREPLY_IDX                                    = 22,
    SBK_QGEOCODINGMANAGER_IDX                                = 26,
    SBK_QGEOCODINGMANAGERENGINE_IDX                          = 28,
    SBK_QGEOMANEUVER_INSTRUCTIONDIRECTION_IDX                = 32,
    SBK_QGEOMANEUVER_IDX                                     = 30,
    SBK_QGEOROUTE_IDX                                        = 34,
    SBK_QGEOROUTEREPLY_ERROR_IDX                             = 38,
    SBK_QGEOROUTEREPLY_IDX                                   = 36,
    SBK_QGEOROUTEREQUEST_TRAVELMODE_IDX                      = 52,
    SBK_QFLAGS_QGEOROUTEREQUEST_TRAVELMODE_IDX               = 10,
    SBK_QGEOROUTEREQUEST_FEATURETYPE_IDX                     = 42,
    SBK_QFLAGS_QGEOROUTEREQUEST_FEATURETYPE_IDX              = 0,
    SBK_QGEOROUTEREQUEST_FEATUREWEIGHT_IDX                   = 44,
    SBK_QFLAGS_QGEOROUTEREQUEST_FEATUREWEIGHT_IDX            = 2,
    SBK_QGEOROUTEREQUEST_ROUTEOPTIMIZATION_IDX               = 48,
    SBK_QFLAGS_QGEOROUTEREQUEST_ROUTEOPTIMIZATION_IDX        = 6,
    SBK_QGEOROUTEREQUEST_SEGMENTDETAIL_IDX                   = 50,
    SBK_QFLAGS_QGEOROUTEREQUEST_SEGMENTDETAIL_IDX            = 8,
    SBK_QGEOROUTEREQUEST_MANEUVERDETAIL_IDX                  = 46,
    SBK_QFLAGS_QGEOROUTEREQUEST_MANEUVERDETAIL_IDX           = 4,
    SBK_QGEOROUTEREQUEST_IDX                                 = 40,
    SBK_QGEOROUTESEGMENT_IDX                                 = 54,
    SBK_QGEOROUTINGMANAGER_IDX                               = 56,
    SBK_QGEOROUTINGMANAGERENGINE_IDX                         = 58,
    SBK_QGEOSERVICEPROVIDER_ERROR_IDX                        = 62,
    SBK_QGEOSERVICEPROVIDER_ROUTINGFEATURE_IDX               = 72,
    SBK_QFLAGS_QGEOSERVICEPROVIDER_ROUTINGFEATURE_IDX        = 20,
    SBK_QGEOSERVICEPROVIDER_GEOCODINGFEATURE_IDX             = 64,
    SBK_QFLAGS_QGEOSERVICEPROVIDER_GEOCODINGFEATURE_IDX      = 12,
    SBK_QGEOSERVICEPROVIDER_MAPPINGFEATURE_IDX               = 66,
    SBK_QFLAGS_QGEOSERVICEPROVIDER_MAPPINGFEATURE_IDX        = 14,
    SBK_QGEOSERVICEPROVIDER_PLACESFEATURE_IDX                = 70,
    SBK_QFLAGS_QGEOSERVICEPROVIDER_PLACESFEATURE_IDX         = 18,
    SBK_QGEOSERVICEPROVIDER_NAVIGATIONFEATURE_IDX            = 68,
    SBK_QFLAGS_QGEOSERVICEPROVIDER_NAVIGATIONFEATURE_IDX     = 16,
    SBK_QGEOSERVICEPROVIDER_IDX                              = 60,
    SBK_QGEOSERVICEPROVIDERFACTORY_IDX                       = 74,
    SBK_QPLACE_IDX                                           = 76,
    SBK_QPLACEATTRIBUTE_IDX                                  = 78,
    SBK_QPLACECATEGORY_IDX                                   = 80,
    SBK_QPLACECONTACTDETAIL_IDX                              = 82,
    SBK_QPLACECONTENT_TYPE_IDX                               = 88,
    SBK_QPLACECONTENT_DATATAG_IDX                            = 86,
    SBK_QPLACECONTENT_IDX                                    = 84,
    SBK_QPLACECONTENTREPLY_IDX                               = 90,
    SBK_QPLACECONTENTREQUEST_IDX                             = 92,
    SBK_QPLACEDETAILSREPLY_IDX                               = 94,
    SBK_QPLACEICON_IDX                                       = 96,
    SBK_QPLACEIDREPLY_OPERATIONTYPE_IDX                      = 100,
    SBK_QPLACEIDREPLY_IDX                                    = 98,
    SBK_QPLACEMANAGER_IDX                                    = 102,
    SBK_QPLACEMANAGERENGINE_IDX                              = 104,
    SBK_QPLACEMATCHREPLY_IDX                                 = 106,
    SBK_QPLACEMATCHREQUEST_IDX                               = 108,
    SBK_QPLACEPROPOSEDSEARCHRESULT_IDX                       = 110,
    SBK_QPLACERATINGS_IDX                                    = 112,
    SBK_QPLACEREPLY_ERROR_IDX                                = 116,
    SBK_QPLACEREPLY_TYPE_IDX                                 = 118,
    SBK_QPLACEREPLY_IDX                                      = 114,
    SBK_QPLACERESULT_IDX                                     = 120,
    SBK_QPLACESEARCHREPLY_IDX                                = 122,
    SBK_QPLACESEARCHREQUEST_RELEVANCEHINT_IDX                = 126,
    SBK_QPLACESEARCHREQUEST_IDX                              = 124,
    SBK_QPLACESEARCHRESULT_SEARCHRESULTTYPE_IDX              = 130,
    SBK_QPLACESEARCHRESULT_IDX                               = 128,
    SBK_QPLACESEARCHSUGGESTIONREPLY_IDX                      = 132,
    SBK_QPLACESUPPLIER_IDX                                   = 134,
    SBK_QPLACEUSER_IDX                                       = 136,
    SBK_QTLOCATION_IDX_COUNT                                 = 138,
};
