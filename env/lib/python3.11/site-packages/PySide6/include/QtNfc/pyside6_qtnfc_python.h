...
enum [[deprecated]] : int {
    ...
    SBK_QNEARFIELDTARGET_TYPE_IDX                            = 34,
...
enum [[deprecated]] : int {
    ...
    SBK_QTNFC_QLIST_QNDEFNFCICONRECORD_IDX                   = 8, // QList<QNdefNfcIconRecord>
    SBK_QTNFC_QLIST_QNDEFNFCTEXTRECORD_IDX                   = 10, // QList<QNdefNfcTextRecord>
    SBK_QTNFC_QLIST_QVARIANT_IDX                             = 12, // QList<QVariant>
    SBK_QTNFC_QLIST_QSTRING_IDX                              = 14, // QList<QString>
    SBK_QTNFC_QMAP_QSTRING_QVARIANT_IDX                      = 16, // QMap<QString,QVariant>
    SBK_QTNFC_CONVERTERS_IDX_COUNT                           = 18,
};
