...
class QSvgRenderer(PySide6.QtCore.QObject):
    ...
    @overload
    def __init__(self, contents: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview], parent: Optional[PySide6.QtCore.QObject] = ...) -> None: ...
    @overload
    ...
    @overload
    def load(self, contents: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> bool: ...
    @overload
...
class QtSvg(Shiboken.Object):
    ...
    class Option(enum.Flag):
        ...
        NoOption                 : QtSvg.Option = ... # 0x0
        Tiny12FeaturesOnly       : QtSvg.Option = ... # 0x1
