...
class QQuickItem(PySide6.QtCore.QObject, PySide6.QtQml.QQmlParserStatus):
    ...
    focusPolicyChanged       : ClassVar[Signal] = ... # focusPolicyChanged(Qt::FocusPolicy)
    ...
    @overload
    def grabToImage(self, callback: Union[PySide6.QtQml.QJSValue, PySide6.QtQml.QJSValue.SpecialValue, bool, str, bytes, bytearray, memoryview, float, int], targetSize: PySide6.QtCore.QSize = ...) -> bool: ...
    @overload
...
class QQuickRhiItem(PySide6.QtQuick.QQuickItem):
    ...
    alphaBlendingChanged     : ClassVar[Signal] = ... # alphaBlendingChanged()
    autoRenderTargetChanged  : ClassVar[Signal] = ... # autoRenderTargetChanged()
    colorBufferFormatChanged : ClassVar[Signal] = ... # colorBufferFormatChanged()
    effectiveColorBufferSizeChanged: ClassVar[Signal] = ... # effectiveColorBufferSizeChanged()
    fixedColorBufferHeightChanged: ClassVar[Signal] = ... # fixedColorBufferHeightChanged()
    fixedColorBufferWidthChanged: ClassVar[Signal] = ... # fixedColorBufferWidthChanged()
    mirrorVerticallyChanged  : ClassVar[Signal] = ... # mirrorVerticallyChanged()
    sampleCountChanged       : ClassVar[Signal] = ... # sampleCountChanged()

    class TextureFormat(enum.Enum):

        RGBA8                    : QQuickRhiItem.TextureFormat = ... # 0x0
        RGBA16F                  : QQuickRhiItem.TextureFormat = ... # 0x1
        RGBA32F                  : QQuickRhiItem.TextureFormat = ... # 0x2
        RGB10A2                  : QQuickRhiItem.TextureFormat = ... # 0x3
...
class QQuickTextDocument(PySide6.QtCore.QObject):
    ...
    errorStringChanged       : ClassVar[Signal] = ... # errorStringChanged()
    modifiedChanged          : ClassVar[Signal] = ... # modifiedChanged()
    sourceChanged            : ClassVar[Signal] = ... # sourceChanged()
    statusChanged            : ClassVar[Signal] = ... # statusChanged()
    textDocumentChanged      : ClassVar[Signal] = ... # textDocumentChanged()

    class Status(enum.Enum):

        Null                     : QQuickTextDocument.Status = ... # 0x0
        Loading                  : QQuickTextDocument.Status = ... # 0x1
        Loaded                   : QQuickTextDocument.Status = ... # 0x2
        Saving                   : QQuickTextDocument.Status = ... # 0x3
        Saved                    : QQuickTextDocument.Status = ... # 0x4
        ReadError                : QQuickTextDocument.Status = ... # 0x5
        WriteError               : QQuickTextDocument.Status = ... # 0x6
        NonLocalFileError        : QQuickTextDocument.Status = ... # 0x7
    ...
    def save(self) -> None: ...
    def saveAs(self, url: Union[PySide6.QtCore.QUrl, str]) -> None: ...
...
class QQuickView(PySide6.QtQuick.QQuickWindow):
    ...
    @overload
    def __init__(self, uri: str, typeName: str, parent: Optional[PySide6.QtGui.QWindow] = ...) -> None: ...
...
class QQuickWindow(PySide6.QtGui.QWindow):
    ...
    class TextRenderType(enum.Enum):
        ...
        CurveTextRendering       : QQuickWindow.TextRenderType = ... # 0x2
...
class QSGRenderNode(PySide6.QtQuick.QSGNode):
    ...
    class RenderState(Shiboken.Object):
        ...
        def get(self, state: Union[bytes, bytearray, memoryview]) -> int: ...
        def projectionMatrix(self) -> PySide6.QtGui.QMatrix4x4: ...
...
class QSGRendererInterface(Shiboken.Object):
    ...
    @overload
    def getResource(self, window: PySide6.QtQuick.QQuickWindow, resource: Union[bytes, bytearray, memoryview]) -> int: ...
...
class QSGSimpleRectNode(PySide6.QtQuick.QSGGeometryNode):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, rect: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect], color: Union[PySide6.QtGui.QColor, str, PySide6.QtGui.QRgba64, Any, PySide6.QtCore.Qt.GlobalColor, int]) -> None: ...
...
class QSGTextNode(PySide6.QtQuick.QSGTransformNode):
    ...
    class RenderType(enum.Enum):
        ...
        QtRendering              : QSGTextNode.RenderType = ... # 0x0
        NativeRendering          : QSGTextNode.RenderType = ... # 0x1
        CurveRendering           : QSGTextNode.RenderType = ... # 0x2

    class TextStyle(enum.Enum):

        Normal                   : QSGTextNode.TextStyle = ... # 0x0
        Outline                  : QSGTextNode.TextStyle = ... # 0x1
        Raised                   : QSGTextNode.TextStyle = ... # 0x2
        Sunken                   : QSGTextNode.TextStyle = ... # 0x3


    def __init__(self) -> None: ...

    def addTextDocument(self, position: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element], document: PySide6.QtGui.QTextDocument, selectionStart: int = ..., selectionCount: int = ...) -> None: ...
    def addTextLayout(self, position: Union[PySide6.QtCore.QPointF, PySide6.QtCore.QPoint, PySide6.QtGui.QPainterPath.Element], layout: PySide6.QtGui.QTextLayout, selectionStart: int = ..., selectionCount: int = ..., lineStart: int = ..., lineCount: int = ...) -> None: ...
    def clear(self) -> None: ...
    def color(self) -> PySide6.QtGui.QColor: ...
    def filtering(self) -> PySide6.QtQuick.QSGTexture.Filtering: ...
    ...
    def setViewport(self, viewport: Union[PySide6.QtCore.QRectF, PySide6.QtCore.QRect]) -> None: ...
