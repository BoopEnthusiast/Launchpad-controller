...
class QSignalSpy(PySide6.QtCore.QObject):
    ...
    @overload
    def __init__(self, obj: PySide6.QtCore.QObject, aSignal: Union[bytes, bytearray, memoryview]) -> None: ...
    @overload
...
class QTest(Shiboken.Object):
    ...
    @staticmethod
    def addColumnInternal(id: int, name: Union[bytes, bytearray, memoryview]) -> None: ...
    @staticmethod
    def asciiToKey(ascii: int) -> PySide6.QtCore.Qt.Key: ...
    @overload
    @staticmethod
    def compare_ptr_helper(t1: PySide6.QtCore.QObject, t2: PySide6.QtCore.QObject, actual: Union[bytes, bytearray, memoryview], expected: Union[bytes, bytearray, memoryview], file: Union[bytes, bytearray, memoryview], line: int) -> bool: ...
    @overload
    @staticmethod
    def compare_ptr_helper(t1: int, t2: int, actual: Union[bytes, bytearray, memoryview], expected: Union[bytes, bytearray, memoryview], file: Union[bytes, bytearray, memoryview], line: int) -> bool: ...
    @staticmethod
    def compare_string_helper(t1: Union[bytes, bytearray, memoryview], t2: Union[bytes, bytearray, memoryview], actual: Union[bytes, bytearray, memoryview], expected: Union[bytes, bytearray, memoryview], file: Union[bytes, bytearray, memoryview], line: int) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def currentAppName() -> Union[bytes, bytearray, memoryview]: ...
    @staticmethod
    def currentDataTag() -> Union[bytes, bytearray, memoryview]: ...
    @staticmethod
    def currentTestFailed() -> bool: ...
    @staticmethod
    def currentTestFunction() -> Union[bytes, bytearray, memoryview]: ...
    @staticmethod
    def currentTestResolved() -> bool: ...
    @overload
    @staticmethod
    def failOnWarning(message: Union[bytes, bytearray, memoryview]) -> None: ...
    @overload
    @staticmethod
    def failOnWarning(messagePattern: Union[PySide6.QtCore.QRegularExpression, str]) -> None: ...
    @staticmethod
    def formatString(prefix: Union[bytes, bytearray, memoryview], suffix: Union[bytes, bytearray, memoryview], numArguments: int) -> Union[bytes, bytearray, memoryview]: ...
    @overload
    @staticmethod
    def ignoreMessage(type: PySide6.QtCore.QtMsgType, message: Union[bytes, bytearray, memoryview]) -> None: ...
    @overload
    @staticmethod
    ...
    def qCleanup() -> None: ...
    @staticmethod
    def qElementData(elementName: Union[bytes, bytearray, memoryview], metaTypeId: int) -> int: ...
    @staticmethod
    def qExpectFail(dataIndex: Union[bytes, bytearray, memoryview], comment: Union[bytes, bytearray, memoryview], mode: PySide6.QtTest.QTest.TestFailMode, file: Union[bytes, bytearray, memoryview], line: int) -> bool: ...
    @overload
    @staticmethod
    def qFindTestData(basepath: str, file: Union[bytes, bytearray, memoryview, NoneType] = ..., line: int = ..., builddir: Union[bytes, bytearray, memoryview, NoneType] = ..., sourcedir: Union[bytes, bytearray, memoryview, NoneType] = ...) -> str: ...
    @overload
    @staticmethod
    def qFindTestData(basepath: Union[bytes, bytearray, memoryview], file: Union[bytes, bytearray, memoryview, NoneType] = ..., line: int = ..., builddir: Union[bytes, bytearray, memoryview, NoneType] = ..., sourcedir: Union[bytes, bytearray, memoryview, NoneType] = ...) -> str: ...
    @staticmethod
    def qGlobalData(tagName: Union[bytes, bytearray, memoryview], typeId: int) -> int: ...
    @staticmethod
    def qRun() -> int: ...
    @staticmethod
    def qSkip(message: Union[bytes, bytearray, memoryview], file: Union[bytes, bytearray, memoryview], line: int) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def setMainSourcePath(file: Union[bytes, bytearray, memoryview], builddir: Union[bytes, bytearray, memoryview, NoneType] = ...) -> None: ...
    @overload
    @staticmethod
    ...
    @staticmethod
    def toPrettyCString(unicode: Union[bytes, bytearray, memoryview], length: int) -> Union[bytes, bytearray, memoryview]: ...
    @overload
    @staticmethod
