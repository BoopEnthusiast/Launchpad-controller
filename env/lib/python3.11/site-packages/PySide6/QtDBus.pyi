...
class QDBusAbstractInterface(PySide6.QtDBus.QDBusAbstractInterfaceBase):
    ...
    def __init__(self, service: str, path: str, interface: Union[bytes, bytearray, memoryview], connection: PySide6.QtDBus.QDBusConnection, parent: PySide6.QtCore.QObject) -> None: ...
    ...
    @overload
    def callWithCallback(self, method: str, args: Sequence[Any], receiver: PySide6.QtCore.QObject, member: Union[bytes, bytearray, memoryview]) -> bool: ...
    @overload
    def callWithCallback(self, method: str, args: Sequence[Any], receiver: PySide6.QtCore.QObject, member: Union[bytes, bytearray, memoryview], errorSlot: Union[bytes, bytearray, memoryview]) -> bool: ...
    ...
    def internalPropGet(self, propname: Union[bytes, bytearray, memoryview]) -> Any: ...
    def internalPropSet(self, propname: Union[bytes, bytearray, memoryview], value: Any) -> None: ...
...
class QDBusArgument(Shiboken.Object):
    ...
    def __lshift__(self, arg: int) -> PySide6.QtDBus.QDBusArgument: ...
    @overload
    def __lshift__(self, arg: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> PySide6.QtDBus.QDBusArgument: ...
    @overload
    def __lshift__(self, arg: int) -> PySide6.QtDBus.QDBusArgument: ...
    @overload
    def __lshift__(self, arg: int) -> PySide6.QtDBus.QDBusArgument: ...
    ...
    def __rshift__(self, arg: int) -> PySide6.QtDBus.QDBusArgument: ...
    @overload
    def __rshift__(self, arg: Union[PySide6.QtCore.QByteArray, bytes, bytearray, memoryview]) -> PySide6.QtDBus.QDBusArgument: ...
    @overload
    def __rshift__(self, arg: int) -> PySide6.QtDBus.QDBusArgument: ...
    @overload
    def __rshift__(self, arg: int) -> PySide6.QtDBus.QDBusArgument: ...
...
class QDBusConnection(Shiboken.Object):
    ...
    @overload
    def callWithCallback(self, message: PySide6.QtDBus.QDBusMessage, receiver: PySide6.QtCore.QObject, returnMethod: Union[bytes, bytearray, memoryview], errorMethod: Union[bytes, bytearray, memoryview], timeout: int = ...) -> bool: ...
    @overload
    def callWithCallback(self, message: PySide6.QtDBus.QDBusMessage, receiver: PySide6.QtCore.QObject, slot: Union[bytes, bytearray, memoryview], timeout: int = ...) -> bool: ...
    @overload
    def connect(self, service: str, path: str, interface: str, name: str, argumentMatch: Sequence[str], signature: str, receiver: PySide6.QtCore.QObject, slot: Union[bytes, bytearray, memoryview]) -> bool: ...
    @overload
    def connect(self, service: str, path: str, interface: str, name: str, receiver: PySide6.QtCore.QObject, slot: Union[bytes, bytearray, memoryview]) -> bool: ...
    @overload
    def connect(self, service: str, path: str, interface: str, name: str, signature: str, receiver: PySide6.QtCore.QObject, slot: Union[bytes, bytearray, memoryview]) -> bool: ...
    @overload
    @staticmethod
    ...
    @overload
    def disconnect(self, service: str, path: str, interface: str, name: str, argumentMatch: Sequence[str], signature: str, receiver: PySide6.QtCore.QObject, slot: Union[bytes, bytearray, memoryview]) -> bool: ...
    @overload
    def disconnect(self, service: str, path: str, interface: str, name: str, receiver: PySide6.QtCore.QObject, slot: Union[bytes, bytearray, memoryview]) -> bool: ...
    @overload
    def disconnect(self, service: str, path: str, interface: str, name: str, signature: str, receiver: PySide6.QtCore.QObject, slot: Union[bytes, bytearray, memoryview]) -> bool: ...
    @staticmethod
...
class QDBusObjectPath(Shiboken.Object):
    ...
    def __init__(self, path: str) -> None: ...
    @overload
    def __init__(self, path: Union[bytes, bytearray, memoryview]) -> None: ...
...
class QDBusSignature(Shiboken.Object):
    ...
    def __init__(self, signature: str) -> None: ...
    @overload
    def __init__(self, signature: Union[bytes, bytearray, memoryview]) -> None: ...
